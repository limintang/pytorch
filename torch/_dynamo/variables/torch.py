...
from torch._subclasses.fake_tensor import is_fake_leaf
...
def _collect_tensors_with_sources(
    ...
    if isinstance(var, TensorVariable):
        ...
        if is_fake_leaf(fake_tensor):
            ...
            if not all(is_fake_leaf(t) for t in plain if isinstance(t, torch.Tensor)):
                raise AssertionError(
